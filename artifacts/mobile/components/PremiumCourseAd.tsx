...
const AD_DATA = [
  {
    ...
    sub: '8 Sesi / Bulan',
    description: 'Kelas intensif SSW Mekki bersama instruktur berpengalaman. 8 sesi langsung per bulan.',
    price: 'Rp 700k/bulan',
    icon: 'target',
  ...
  },
  {
    ...
    sub: '8 Sesi / Bulan',
    description: 'Kelas bahasa Jepang intensif level N3. 8 sesi per bulan bersama tutor native.',
    price: 'Rp 700k/bulan',
    icon: 'book-open',
